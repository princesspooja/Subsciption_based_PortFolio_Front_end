                        ...
                        <ul className="catogory-link">
                            <li className="active-li">
                                <div>
                                    ...
                                    <Image src="/images/portfolio/desk4.jpg" width={80} height={80} alt="carouser-1" />
                                    <a id="ecommerce-a">Logo Design</a>
                                </div>
                            </li>
...
export default Investment_App_Ui;