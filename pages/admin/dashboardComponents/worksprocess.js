...
const Workprocess = () => {
    return (<>
        ...
        <div className="page_header">
            <h4 className="table_h4">Work Process</h4>
            <ul className="table_ul">
                ...
                <li className="seprator_data"><i className="fa fa-angle-right"></i></li>
                <li className="home_datas"><a href=""> Work Process</a></li>
            </ul>
        </div>
                    ...
                    <div className="table_header">
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="table_title d-inline-block">Work Process</div>
                                <div className="row">
                            ...
                            <div className="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                                <a href="" className="btn btn-primary float-right btn-sm" id="float_rigth" data-bs-toggle="modal" data-bs-target="#exampleModalworkprocess"><i className="fa fa-plus"></i>Add Feature</a>
                            </div>
                        </div>
                    </div>
        ...
        <div className="modal fade" id="exampleModalworkprocess" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form>
