...
const Blogs = () => {
    return (<>
        ...
        <div className="page_header">
            <h4 className="table_h4">Blogs</h4>
            <ul className="table_ul">
                ...
                <li className="home_datas"><a> Blog Page </a></li>
                <li className="seprator_data"><i className="fa fa-angle-right"></i></li>
                <li className="home_datas"><a href=""> Blogs</a></li>
            </ul>
        </div>
                    ...
                    <div className="table_header">
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="table_title d-inline-block">Blogs</div>
                                <div className="row">
                            ...
                            <div className="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                                <a href="" className="btn btn-primary float-right btn-sm" id="float_rigth" data-bs-toggle="modal" data-bs-target="#exampleModalblogs"><i className="fa fa-plus"></i>Add Blog</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <table className="table table-light table-striped  mt-3 " id="shri-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>Mark</td>
                                                            <td>MISC</td>
                                                            <td>Richard McClintock, a Latin pr...</td>
        ...
        <div className="modal fade" id="exampleModalblogs" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form>
