    ...
    <link
        ...
        <title>Profilex - User Dashboard-edit profile</title>
            ...
            <div className="logo-page-header">
                <h4 className="logo-page-title">Logo</h4>
              ...
              <div className="col-md-12">
                <div className="logo-card">
                  <div className="logo-card-header ">
                    <div className="logo-card-title">Update logo</div>
                  </div>
                            ...
                            <div className="col-g-12">
                              <div className="form-group">
                                ...
                                <div className="col-md-12 show-image">
                                  <Image src="/adminDashboard/settingimage/logo.png" width="115" height="33" alt="image" className="logo-image"/>
                                </div>
