                                            ...
                                            <table className="table table-light table-striped  mt-3 " id="shri-table">
                                                ...
                                                <tbody>
                                                  <tr>
                                                    ...
                                                    <td className="td-data"><a ><button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalrejp"><i className="fa fa-edit"></i><span>Mail</span></button></a>  <a><button type="button" className="btn btn-danger"><i className="fa fa-trash"></i><span>Delete</span> </button></a></td>
                                                  </tr>
                                             </tbody>
                                              </table>
                                        </div>
